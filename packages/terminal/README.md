...
```bash
npm install @charclaw/terminal @daytonaio/sdk
```
...
import { setupTerminal, WebSocketTerminal } from "@charclaw/terminal"
...
```typescript
import { setupTerminal } from "@charclaw/terminal"
...
```typescript
import { getTerminalStatus } from "@charclaw/terminal"
...
```typescript
import { stopTerminal } from "@charclaw/terminal"
...
```tsx
import { WebSocketTerminal } from '@charclaw/terminal'
...
```typescript
import { getPtyServerCode, getPtyServerPackageJson, PTY_SERVER_PORT } from "@charclaw/terminal/server"
