 ...
 *
 * Agent-related types are imported from @charclaw/common and re-exported
...
// =============================================================================
// Re-export agent types from @charclaw/common
// =============================================================================
...
export type { AgentDisabledReason } from "@charclaw/common"

// Import Agent type for use in this file
import type { Agent, ModelOption, UserCredentialFlags } from "@charclaw/common"
import { agentModels, hasCredentialsForModel } from "@charclaw/common"
...
// Note: @charclaw/common has simpler ContentBlock and ToolCall types.
...
export type IssueStatus = "backlog" | "claimed" | "in_progress" | "blocked" | "done" | "failed"
...
export interface Issue {
  ...
  assigneeAgent: AgentProfileSummary | null
  createdAt: string
  updatedAt: string
